export default (function () {
  ...
  let timer = null;
  return function (msg, { showTime = 3000, bgColor = 'rgba(0,0,0,.4)', fontColor = '#fff', fontSize = '12px', lineHeight = '18px', bottom = "10%" } = {}) {
    const el = document.querySelector('.fry_toast') || cDiv
    el.style = `background-color:${bgColor};color:${fontColor};font-size:${fontSize};line-height:${lineHeight};bottom:${bottom}`;
    el.innerText = msg
    body.appendChild(el)
